...
cat > "$CHAPTER3/complex_dates.txt" << 'EOF'
Apr 19
Apr 27
Apr 16
Apr 24
...
# Chapter 8: join/diff/tr text practice files (cut/paste/join, comm/diff/patch, tr/sed/awk/aspell)
...
# Chapter 9: disk usage + log snapshots (used to explain diff/sed with “before vs after”)
